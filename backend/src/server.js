...
app.use(cors({
  origin: process.env.NODE_ENV === 'production' 
    ? ["https://smartcampus-two.vercel.app", "https://smartcampus-git-main-manojs-projects-87d0f296.vercel.app", process.env.CORS_ORIGIN, process.env.FRONTEND_URL, /\.netlify\.app$/]
